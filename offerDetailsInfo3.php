...
if(isset($_POST["f_hire"])){
	...
	$sql = "INSERT INTO selected (f_username, offer_id, e_username, price, valid, quantity) VALUES ( '$username','$offer_id', '$f_hire','$f_price',1, '$f_quantity')";
	// $sql = "INSERT INTO accepted (f_username, offer_id, e_username, price, valid) VALUES ( '$username','$offer_id', '$f_hire','$f_price',1)";
...
include('includes/header.php');
	...
	// include('includes/client-navbar.php'); //changed this mornig
...
function generate_bill(){
	...
	// $query=mysqli_query($con,"select * from `farm_ouput` left join `accepted` on accepted.offer_id=farm_ouput.offer_id where farm_ouput.offer_id='$offer_id'  ");
	...
	while($row = mysqli_fetch_array($query)){
	  ...
	  <label> <b>Price Per Bag:</b> Ksh.</label>'.$row["selling_price"].'<br/><br/>
...
<!--client Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<!-- <a disabled href="<?php //echo $linkBtn; ?>" id="applybtn" type="button" class="btn btn-warning btn-lg"><?php //echo $textBtn; ?></a> -->
			<p></p>
		</div>
...
<!--client Profile Details-->	
		<!-- <div id="applicant" class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-success">
			  <!-- <div class="panel-heading"><h3>Buyersss</h3></div>
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                  <tr>
                      <td style="font-weight: bold; font-style:italic;">Farmers's username</td>
...
// 						echo '
//                         <form action="offerDetailsInfo3.php" method="post">
...
<div id="applicant" class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-success">
			  ...
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                  <tr>
                      <td style="font-weight: bold; font-style:italic;">Buyers username
                    </td>
                      <!-- <td style="font-weight: bold; font-style:italic;">Price</td> -->
                  </tr>
                  <?php
...
<!-- <td><input type = "submit"  name ="generate_bill" class = "btn btn-success" value="Print Receipt"/>	</td>			 -->

					<?php 

                    // $sql = "SELECT * FROM apply WHERE offer_id='$offer_id' ORDER BY bid";
                    $sql = "select * from `apply` left join `market_request` on market_request.id=apply.offer_id where offer_id='$offer_id' ORDER BY bid";
					$result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                        // output data of each row
                        while($row = $result->fetch_assoc()) {
				...
				if ($result->num_rows > 0) {
                        ...
                        <form action="offerDetailsInfo3.php" method="post">
                            ...
                            <td><input type="submit" class="btn btn-link btn-lg" value="Sdell"></td>
                            </tr>
						</form>';					
...
if ($_SESSION["Usertype"] == 1) {
	echo '
	<center><a href="sendMessage2.php" class="btn btn-info"><span class="glyphicon glyphicon-envelope"></span>  Send Message</a></center> ';
}
