...
// 	  <label> <b>Client Name:</b> </label>'.$row["f_username"].'<br/><br/>
// 	  <label> <b>Farmer Name:</b> </label>'.$row["e_username"].'<br/><br/>
...
<div id="applicant" class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			  <!-- <div class="panel-heading"><h3>Bbbbbbbbbbidders</h3></div> -->
		...
		<div id="applicant" class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-success">
			  ...
			  <div class="panel-body"><h4>
                  ...
                  <tr>
                      <td style="font-weight: bold; font-style:italic;">Bidder's username
                    </td>
