		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown" style="background:#000;padding:0 20px 0 20px;">
			        <a class="dropdown-toggle" data-t oggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span> <?php echo $username; ?>
			        </a>

					<!-- <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo (!empty($row['photo'])) ? 'image/'.$row['photo'] : 'image/profile.jpg' ; ?>  height='30px' width='30px' " class="user-image" alt="User Image">
