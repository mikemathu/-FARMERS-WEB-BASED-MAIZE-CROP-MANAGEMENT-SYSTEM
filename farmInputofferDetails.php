...
function generate_bill(){
	...
	while($row = mysqli_fetch_array($query)){
	  ...
	  <label> <b>Maize type:</b> </label>'.$row["item_type"].'<br/><br/>
	  <label> <b>Number of bags:</b> </label>'.$row["quantity"].'<br/><br/>
	  <label> <b>Price Per Bag:</b> Ksh.</label>'.$row["selling_price"].'<br/><br/>
	  <label> <b>Buyers Name:</b> </label>'.$row["f_username"].'<br/><br/>
	  <label> <b>Sellers Name:</b> </label>'.$row["e_username"].'<br/><br/>
