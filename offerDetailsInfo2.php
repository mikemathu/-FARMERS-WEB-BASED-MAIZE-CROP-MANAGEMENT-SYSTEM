    ...
    if($result==true){
		...
		if($result==true){
			...
			if($result==true){
				...
				header("location: offerDetailsInfo2.php");
			}
		}
    }
}
		...
		<div id="applicant" class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-success">
			  ...
			  <div class="panel-body"><h4>
                  ...
                  <tr>
                      <td style="font-weight: bold; font-style:italic;">Client's username</td>
...
if ($result->num_rows > 0) {	
						...
						echo '
                        <form action="offerDetailsInfo2.php" method="post">
                        ...
                        <form action="offerDetailsInfo2.php" method="post">
							...
							<td><a href="offerDetailsInfo2.php?id='.$offer_id.'" class="btn btn-link btn-lg">Sell<a/></td>
                            </tr>
						</form>';					
